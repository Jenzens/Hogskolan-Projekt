...
{
    public class CFormViewModel : Screen
    {
        #region Fields
        ...
        public List<long> CompanyOrgNrs { get; set; }
        ...
        public CompanyData CompanyData
        {
            ...
            set { _companyData = value; NotifyOfPropertyChange(() => _companyData); }
        }
        ...
        public CFormViewModel(bool edit, IHTabCViewModel tab, Sale row)
        {
            _edit = edit;
            _reverseedit = !_edit;
            _tab = tab;
            ...
            Sale = row;
            ChangeCompany(row.InsuranceTaker.GetCompanyData);
        ...
        public void ResetModelData()
        {
            ...
            {
                ZipCity = new ZipCity(),
                CompanyContactData = new CompanyContactData()
            };
        ...
        public void CompanyOrgNrChange(System.Windows.Controls.TextBox data)
        {
            if (data.Text.Length > 0) {
                ...
                if (number > 0)
                {
                    foreach (long orgnr in CompanyOrgNrs)
                    {
                        if (orgnr == number) // FOUND ONE
                        {
                            ChangeCompany(DataManager.GetCompany(orgnr));
                            this.Refresh();
                            break;
                        }
                    }
        ...
        public void ChangeCompany(CompanyData data)
        {
            CompanyData = data;
        }
        ...
        public void SaveButton()
        {
            ...
            _insuranceTaker.CompanyData.Add(_companyData);
        ...
        public void EditSale(List<InsuranceApplicationRow> _appRows)
        {
            ...
            _insuranceTaker.CompanyData.Clear();
        }
        ...
        private void PopulateLists()
        {
            ...
            CompanyOrgNrs = DataManager.GetCompaniesOrgNr();
        }
